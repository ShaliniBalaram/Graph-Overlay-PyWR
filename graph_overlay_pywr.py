...
PYWR_NODE_TYPES = [
    ...
    "rivergauge", "riversplit", "riversplitwithgauge",
    # Groundwater domain
    "keatingaquifer",
    # Fallback
    "other",
...
TYPE_DEFAULTS: dict[str, dict[str, str]] = {
    ...
    "riversplitwithgauge":    {"mrf": "0.0", "mrf_cost": "0.0", "cost": "0.0",
                               "factors": "0.5, 0.5"},
    # Groundwater
    ...
    def _get_pywr_json(self):
        ...
        for n in self.placed_nodes:
            entry = {
                ...
                "type": n["type"],
                "position": {
                    "editor_position": [round(n["px"], 1), round(n["py"], 1)],
                    "schematic":       [round(n["px"], 1), round(n["py"], 1)],
                },
            }
